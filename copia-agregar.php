...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO copiadepelicula (idCopia, idFormatoPelicula, idPelicula) VALUES (%s, %s, %s)",
...
<title>Ingresar Nueva Copia</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVA COPIA</h1>
