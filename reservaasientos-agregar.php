...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO reservaasientos (usuario, idAsiento, estado) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "reservaasientos.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Ingresar Nueva Reserva de asiento</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVA RESERVA DE ASIENTO</h1>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="formregistro" id="formregistro" onsubmit="return validateformregistro();">
    <table align="center">
        ...
        <td><input type="text" name="usuario" value="" size="32" class="campo" /></td>
      </tr>
		
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Id Asiento:</td>
        <td><input type="text" name="idAsiento" value="" size="32" class="campo" /></td>
      </tr>
      <tr valign="baseline">
