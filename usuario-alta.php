...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO usuarios (idUsuario, NombreUsuario, CedulaUsuario, EmailUsuario, password, idcargo, Estado) VALUES (%s, %s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString(md5($_POST['password']), "int"),
...
<title>Ingresar Nueva Usuario</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVO USUARIO</h1>
  
  <form action="<?php echo $editFormAction; ?>" method="post" name="formregistro" id="formregistro" onsubmit="return validateformregistro();">
    <table align="center">
		
		<tr valign="baseline">
        <td nowrap="nowrap" align="right">Id Usuario:</td>
        <td><input type="text" name="idUsuario" value="" size="32" class="campo" /></td>
      </tr>
		
			
		<tr valign="baseline">
        <td nowrap="nowrap" align="right">Nombre Usuario:</td>
        <td><input type="text" name="NombreUsuario" value="" size="32" class="campo" /></td>
      </tr>
		
		<tr valign="baseline">
        <td nowrap="nowrap" align="right">Cedula Usuario:</td>
        <td><input type="text" name="CedulaUsuario" value="" size="32" class="campo" /></td>
      </tr>
		
		<tr valign="baseline">
        <td nowrap="nowrap" align="right">Email Usuario:</td>
        <td><input type="text" name="EmailUsuario" value="" size="32" class="campo" /></td>
      </tr>
		
		<tr valign="baseline">
        <td nowrap="nowrap" align="right">Password:</td>
        <td><input type="text" name="password" value="" size="32" class="campo" /></td>
      </tr>
