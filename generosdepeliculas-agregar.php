...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO generosdepeliculas (idGenero, descripcion) VALUES (%s, %s)",
  ...
  $insertGoTo = "generosdepeliculas.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Ingresar Nuevo Genero De Pelicula</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVO GENERO DE PELICULA</h1>
