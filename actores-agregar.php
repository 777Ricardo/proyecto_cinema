...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO actores (apellidos, nombres, imagen) VALUES (%s, %s, %s )",
...
<title>Ingresar nuevo actor o actora</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVO ACTOR O ACTORA</h1>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="formregistro" id="formregistro" onsubmit="return validateformregistro();">
    <table align="center">
        ...
        <td><input type="text" name="apellidos" value="" size="32" class="campo" /></td>
      </tr>
	...
	<tr valign="baseline">
        ...
        <td><input name="imagen" class="campo" value="" size="32" /></td>
      </tr>
