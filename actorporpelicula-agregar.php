...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO actorporpelicula (idActor, idPelicula, rol) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "actorporpelicula.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Ingresar Nuevo Actor por Pelicula</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVO ACTOR POR PELICULA</h1>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="formregistro" id="formregistro" onsubmit="return validateformregistro();">
    <table align="center">
        ...
        <td><input type="text" name="idActor" value="" size="32" class="campo" /></td>
      </tr>
      ...
      <tr valign="baseline">
        ...
        <td><input type="text" name="rol" value="" size="32" class="campo"/></td>
		</tr>
