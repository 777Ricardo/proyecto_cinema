...
?>
<?php
$vargeneroporpeliculas_DatosActualizar = "0";
if (isset($_GET["generoporpeliculas"])) {
  $vargeneroporpeliculas_DatosActualizar = $_GET["generoporpeliculas"];
}

$query_DatosActualizar = sprintf("SELECT * FROM generoporpeliculas WHERE generoporpeliculas.idGenero = %s", GetSQLValueString($vargeneroporpeliculas_DatosActualizar, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE generoporpeliculas SET idPelicula=%s WHERE idGenero=%s",
  ...
  $updateGoTo = "generoporpeliculas.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Actualizar Información de Generos por Pelicula</title>
<link rel="stylesheet" href="css/estilos.css" type="text/css"/>
</head>
<body>
<br><br><br>
<h1 align="center">ACTUALIZAR INFORMACION DE GENEROS POR PELICULA</h1>
