...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO clasificacionpelicula (Detalles) VALUES (%s)",
  ...
  $insertGoTo = "clasificacionpelicula.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Ingresar Nueva clasificacion por pelicula</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVA CLASIFICACION DE PELICULA</h1>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="formregistro" id="formregistro" onsubmit="return validateformregistro();">
    <table align="center">
        ...
        <td><input type="text" name="Detalles" value="" size="32" class="campo" /></td>
      </tr>		
