...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO productoraporpelicula (idProductora, idpelicula) VALUES (%s, %s)",
  ...
  $insertGoTo = "productoraporpelicula.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Ingresar Nueva Productora Por Pelicula</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVA PRODUCTORA POR PELICULA</h1>
