...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO directores (apellidos, nombres, imagen) VALUES (%s, %s, %s)",
...
<title>Ingresar Nuevo Director</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVO DIRECTOR</h1>
