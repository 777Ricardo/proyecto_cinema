...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO formatoaudio (idAudio, descricion) VALUES (%s, %s)",
...
<title>Ingresar Nuevo Formato de audio</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVO FORMATO DE AUDIO</h1>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="formregistro" id="formregistro" onsubmit="return validateformregistro();">
    <table align="center">
      ...
      <tr valign="baseline">
        ...
        <td><input type="text" name="descricion" value="" size="32" class="campo" /></td>
      </tr>      
