...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO distribuidoresporpelicula (idPelicula, idDistrbuidora) VALUES (%s, %s)",
					   
					   GetSQLValueString($_POST['idPelicula'], "int"),
                       GetSQLValueString($_POST['idDistrbuidora'], "int"));
	

  
  $Result1 = mysqli_query($conexioncine,$insertSQL) or die(mysqli_error($conexioncine));

  $insertGoTo = "distribuidoresporpelicula.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Ingresar Nuevo Distribuidor por Pelicula</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVO DRISTRIBUIDOR POR PELICULA</h1>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="formregistro" id="formregistro" onsubmit="return validateformregistro();">
    <table align="center">
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Id Distribuidora:</td>
        <td><input type="text" name="idDistrbuidora" value="" size="32" class="campo" /></td>
      </tr>
