...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formregistro")) {
  $insertSQL = sprintf("INSERT INTO horafecha (hora, fecha) VALUES (%s, %s)",
...
<title>Ingresar Nueva Hora y Fecha</title>
<link rel="stylesheet" href="css/estilos.css"  type="text/css" />
</head>
<body>
<br><br><br><br>
<h1 align="center">INGRESAR NUEVA HORA Y FECHA</h1>
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="formregistro" id="formregistro" onsubmit="return validateformregistro();">
    <table align="center">
      ...
      <tr valign="baseline">
        ...
        <td><input type="text" name="fecha" value="" size="32" class="campo" /></td>
      </tr>
